...
createAncorPeerTx() {
	...
	for orgmsp in SellerMSP BuyerMSP FreightMSP; do
...
echo "Join Seller peers to the channel..."
joinChannel 1
echo "Join Buyer peers to the channel..."
joinChannel 2
echo "Join Freight peers to the channel..."
joinChannel 3
...
updateAnchorPeers 2
echo "Updating anchor peers for freight..."
updateAnchorPeers 3
